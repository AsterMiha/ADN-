...
class Alergii extends StatelessWidget {
  @override
...
class BodyLayoutState extends State<BodyLayout> {
  ...
  Future<File> get _localFile async {
	...
	print("""
found local path\n\n\n""");
    return File('$path/allergies.txt');
  }
    ...
    return new Container(
		child: Column(
			...
			children: <Widget>[
				...
				RaisedButton(
				child: Text('Add allergy', style: TextStyle(fontSize: 10)),
				onPressed: () {
					_insertSingleItem();
				},
				),
				...
				TextField(
					...
					decoration: InputDecoration(
					hintText: 'Remove allergy',
					),
				),
				RaisedButton(
				child: Text('Remove allergy', style: TextStyle(fontSize: 10)),
				onPressed: () {
					_removeSingleItem();
				},
				),
